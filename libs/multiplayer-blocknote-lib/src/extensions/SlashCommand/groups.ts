...
export const FORMAT_BLOCKS: Command[] = [
...

  {
    ...
    label: 'Code Block',
    iconName: 'SquareCode',
    description: '', // 'Insert a code block with basic syntax highlighting.',
    shouldBeHidden: editor => editor.isActive('columns'),
    action: editor => {
...
export const INSERTION_BLOCKS: Command[] = [
  {
    name: 'chartBlock',
    ...
    shouldBeHidden: editor => editor.isActive('columns'),
    action: editor => {
      editor.chain().focus().setChartBlock().run()
    },
  },
  {
    name: 'image',
...
export const BASE_BLOCKS: Group[] = [
  {
    name: 'format',
    title: 'Format',
