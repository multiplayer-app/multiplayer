...
export namespace BlocknoteTemplates {
  ...
  export function getEmptyAuthorization(
    ...
    | Notebook.AuthorizationBasic
    | Notebook.AuthorizationBearerToken
    | Notebook.AuthorizationJWTBearer
    | Notebook.AuthorizationAPIKey
    | null {
    switch (type) {
