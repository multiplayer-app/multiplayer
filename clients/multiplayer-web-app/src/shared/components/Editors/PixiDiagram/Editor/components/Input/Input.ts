...
export default class TextInput extends Container {
  ...
  state: any;
  _resolution: any;
  _canvas_bounds: { top: any; left: any; width: any; height: any };
  _box: any;
  _surrogate: any;
  _surrogate_hitbox: Graphics;
  _surrogate_mask: Graphics;
  _font_metrics: any;
  constructor(styles) {
    super();
  ...
  _addListeners() {
    ...
    this.on("destroyed", this._onRemoved.bind(this));
  ...
  _createSurrogate() {
    ...
    this.addChild(this._surrogate_hitbox as DisplayObject);

    this._surrogate_mask = new Graphics();
    this.addChild(this._surrogate_mask as DisplayObject);
  ...
  _destroySurrogate() {
    ...
    this.removeChild(this._surrogate_mask as DisplayObject);
    this.removeChild(this._surrogate_hitbox as DisplayObject);
