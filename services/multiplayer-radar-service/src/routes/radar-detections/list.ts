...
export default async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const type = req.query.type as RadarDetectionType | undefined
    ...
    const componentAliasName = req.query.componentAliasName as boolean | undefined
    ...
    const [
      totalRadarDetectionsCount,
      radarDetectionsStream,
    ] = await Promise.all([
      RadarDetectionService.getRadarDetectionsWithSignCount(_filter),
      RadarDetectionService.listRadarDetectionsWithSign(
        _filter,
        {
          skip,
          limit,
    ...
    const cursor = {
      skip,
      limit,
      total: totalRadarDetectionsCount,
    }
