...
export class EntityRequest {
  ...
  async createEntity(branchId: string | Types.ObjectId, body: EntityCreateRequest) {
    const url = `/version/workspaces/${this.context.workspaceId}/projects/${this.context.projectId}/branches/${branchId}/entities`
  ...
  async updateEntity(branchId: string | Types.ObjectId, entityId: string | Types.ObjectId, body: EntityUpdateRequest) {
    const url = `/version/workspaces/${this.context.workspaceId}/projects/${this.context.projectId}/branches/${branchId}/entities/${entityId}`
