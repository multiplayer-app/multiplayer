...
export class ProjectBranchRequest {
  ...
  async createProjectBranch(body: ProjectBranchCreateRequest) {
    const url = `/version/workspaces/${this.context.workspaceId}/projects/${this.context.projectId}/branches`
  ...
  async getProjectBranchState(branchId: string | Types.ObjectId, params: ProjectBranchStateParams = {}) {
    const url = `/version/workspaces/${this.context.workspaceId}/projects/${this.context.projectId}/branches/${branchId}/state`
