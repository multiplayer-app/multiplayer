...
describe('Project state', () => {
  ...
  beforeAll(async () => {
    ...
    const entityAResponse = await request(app)
      .post(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${defaultProjectBranch._id}/entities`)
    ...
    const { body: newBranchA } = await request(app)
      .post(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .send({
    ...
    const entityFResponse = await request(app)
      .post(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${featureBranchA._id}/entities`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .send({
    ...
    const bulkResponse = await request(app)
      .post(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${defaultProjectBranch._id}/entities/bulk`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .send([{
    ...
    const entityDResponse = await request(app)
      .post(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${featureBranchC._id}/entities`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .send({
    ...
    const merge1Response = await request(app)
      .post(`/internal${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/merge`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .send({
  ...
  test.only('Get project latest state on main', async () => {
    const { body: branchState } = await request(app)
      .get(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${defaultProjectBranch._id}/state`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .expect(200)
  ...
  test.only('Get project state on feature A commit 4', async () => {
    const { body: branchState } = await request(app)
      .get(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${featureBranchA._id}/state?commit=${commitA4._id}`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .expect(200)
  ...
  test.only('Get project state on feature B commit 4', async () => {
    const { body: branchState } = await request(app)
      .get(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${featureBranchB._id}/state?commit=${commitB4._id}`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .expect(200)
  ...
  test.only('Get project state on feature C commit 4', async () => {
    const { body: branchState } = await request(app)
      .get(`${API_PREFIX}/version/workspaces/${workspace._id}/projects/${project._id}/branches/${featureBranchC._id}/state?commit=${commitC4._id}`)
      .set('Accept', 'application/json')
      .set('Cookie', [cookie])
      .expect('Content-Type', /application\/json/)
      .expect(200)
